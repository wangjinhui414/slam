...
typedef struct TYPE_USER_INFO//在线用户信息
{
	SOCKET sockConn;
	TAB_USER usertab;
	string dovehiclename;
	int usertype;
	DWORD ip;
	DWORD port;

}TYPE_USER_INFO, *pTYPE_USER_INFO;
...
extern map<string, TYPE_USER_INFO> g_usersonline;
extern map<string, TYPE_VEHICLE_INFO*> g_vehiclesonline;
extern map<string, SOCKET> g_socket8800;
#endif